...
//添加校园平面图覆盖物
   var bound_shool = new AMap.Bounds([116.959959,36.676108], [116.967507,36.683181]);
   var groundImage_shool = {  
	        opacity: 1,   //图片透明度  
	        clickable: true,//图片相应鼠标点击事件，默认：false  
	        map: map     //图片叠加的地图对象  
	    }
	var groundImage_s = new AMap.GroundImage('images/123456.jpg',bound_shool,groundImage_shool);
